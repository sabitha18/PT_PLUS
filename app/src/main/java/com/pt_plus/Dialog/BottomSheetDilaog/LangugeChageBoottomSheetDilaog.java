...
public class LangugeChageBoottomSheetDilaog extends BottomSheetDialogFragment {
    private SuperActivity context;

    public LangugeChageBoottomSheetDilaog(SuperActivity fragmentActivity) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bottom_sheet_language_change, container, false);
...
private CardView cardViewSubmit;
    ...
    private void initView(View view) {
        ...
        radioEn = view.findViewById(R.id.radio_en);
        radioAr = view.findViewById(R.id.radio_ar);
//
//
        ...
        radioAr.setText(R.string.arabic);
        radioEn.setText(R.string.english);
            ...
            switch (view.getId()) {
                ...
                case R.id.carview_submit: {
                    ...
                    if(radioAr.isChecked()){
                        PrefUtils.saveToPrefs(context, PrefKeys.PREF_LANG,false);
                    }
                    if(radioEn.isChecked()){
                        PrefUtils.saveToPrefs(context, PrefKeys.PREF_LANG,true);
                    }
