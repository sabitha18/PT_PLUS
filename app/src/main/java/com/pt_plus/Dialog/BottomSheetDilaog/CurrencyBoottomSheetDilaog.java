...
public class CurrencyBoottomSheetDilaog extends BottomSheetDialogFragment {
    private SuperActivity context;

    public CurrencyBoottomSheetDilaog(SuperActivity fragmentActivity) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bottom_sheet_currency_change, container, false);
