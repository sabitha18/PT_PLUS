...
public class FragmentCenterSubCategory extends SuperFragment {
    ...
    private final CallBack callBack = new CallBack() {
        ...
        public void onSuccess(int serviceId, JSONObject jsonObject, int statusCode) {
            try {
               if (serviceId == ServiceNames.REQUEST_ID_GET_CENTER_SUB_CATEGORIES) {
...
//
                ...
                if (CommonCardCategoryModel != null) {
                    ...
                    bundle.putSerializable("CommonCardCategoryModel", CommonCardCategoryModel);
