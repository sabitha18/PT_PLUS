...
import com.pt_plus.Adapter.ExploreTrainersListAdapter;
...
public class FragmentExploreTrainer extends SuperFragment {

private  List<TrainersModel> trainersModelList;
    public FragmentExploreTrainer(List<TrainersModel> model) {
    ...
    private ExploreTrainersListAdapter trainersFilterListAdapter;
    private RecyclerView recyclerViewActivities, recyclerViewTrainerList;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_explore_trainer, container, false);
        initView(view);
        return view;
    }
    ...
    private void  initView(View view){
        ...
        trainersFilterListAdapter = new ExploreTrainersListAdapter(getFragmentActivity(), null, _handler);
        ...
        if(trainersModelList != null && trainersModelList.size() > 0){
            ...
            trainersFilterListAdapter.updateData(trainersModelList);
