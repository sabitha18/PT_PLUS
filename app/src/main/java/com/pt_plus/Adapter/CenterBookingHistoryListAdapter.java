...
public class CenterBookingHistoryListAdapter extends RecyclerView.Adapter<CenterBookingHistoryListAdapter.ViewHolder> {
    ...
    public CenterBookingHistoryListAdapter(SuperActivity activity, List<BookingModel> groupList, Handler handler) {
...
//        inflater = activity.getLayoutInflater();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_center_booking_history_list, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        try {
            ...
            AppLogger.log("sdadsfadsfasd              " + item);
            Glide.with(_activity).load(item.centerModel.thumbnail_img).placeholder(R.drawable.no_image).into(holder.imgTrainer);
            Glide.with(_activity).load(item.planModel.thumbnail_img).placeholder(R.drawable.no_image).into(holder.imgPlan);
            holder.txtTitle.setText(item.centerModel.name);
