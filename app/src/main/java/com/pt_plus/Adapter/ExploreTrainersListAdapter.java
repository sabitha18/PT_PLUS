...
public class ExploreTrainersListAdapter extends RecyclerView.Adapter<ExploreTrainersListAdapter.ViewHolder> {
    ...
    public ExploreTrainersListAdapter(SuperActivity activity, List<TrainersModel>  groupList, Handler handler) {
...
//        inflater = activity.getLayoutInflater();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_explore_trainer_list, parent, false);
