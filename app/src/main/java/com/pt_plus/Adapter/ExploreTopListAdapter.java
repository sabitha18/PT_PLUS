...
public class ExploreTopListAdapter extends RecyclerView.Adapter<ExploreTopListAdapter.ViewHolder> {
    ...
    public ExploreTopListAdapter(SuperActivity activity, List<TrainersModel>  groupList, Handler handler) {
...
//        inflater = activity.getLayoutInflater();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_explore_top_list, parent, false);
...
//            holder.cardViewGroupBlock.setBackgroundResource(item.drwableId);
            ...
            holder.txtSpc.setText( item.distance+ " away  "+item.category);
