...
public class HorizondalTypeListAdapter extends RecyclerView.Adapter<HorizondalTypeListAdapter.ViewHolder> {
    ...
    public HorizondalTypeListAdapter(SuperActivity activity, List<FilterModel>  groupList, Handler handler) {
...
//        inflater = activity.getLayoutInflater();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_horizondal_type_list, parent, false);
...
//            holder.cardViewGroupBlock.setBackgroundResource(item.drwableId);
            ...
            if(item.isSelected){
                if(sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                    holder.lnrMain.setBackgroundDrawable(ContextCompat.getDrawable(_activity, R.drawable.selected_type_buttn_shape_grey) );

                } else {
                    holder.lnrMain.setBackground(ContextCompat.getDrawable(_activity, R.drawable.selected_type_buttn_shape_grey));
                }
            }else {
                if(sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                    holder.lnrMain.setBackgroundDrawable(null );
                } else {
