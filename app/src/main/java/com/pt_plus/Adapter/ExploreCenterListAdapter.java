...
public class ExploreCenterListAdapter extends RecyclerView.Adapter<ExploreCenterListAdapter.ViewHolder> {
    ...
    public ExploreCenterListAdapter(SuperActivity activity, List<CommonCardCategoryModel>  groupList, Handler handler) {
...
//        inflater = activity.getLayoutInflater();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_explore_center_list, parent, false);
